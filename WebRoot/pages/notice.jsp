...
<BODY>
<form action="/workcorrectionsys/pages/notice.jsp?f=f" name="f1" method="post">

<%
String url="/workcorrectionsys/pages/notice.jsp?1=1";
String key = request.getParameter("key")==null?"":request.getParameter("key");
String sql = "select * from notice a where  1=1 and type=1";
if(!key.equals(""))
{
url+="&key="+key;
...
border=0>
  <TBODY>
  <TR>
    <TD colSpan=2 height=24>新闻管理</TD> 
  </TR>
  <TR>
  ...
  <TR>
    <TD height=24 colspan="2" align="center" class=forumrow>
      <input type="submit" name="Submit"  value="查询信息">&nbsp;&nbsp;&nbsp;<input type="button" onclick="add();" name="Submit" value="添加新闻">
  ...
  function update(no)
  {
   location.href("upnotice.jsp?id="+no);
  }
  </script>
...
border=0>
  ...
  if(did!=null)
  {
  String s = "delete from  notice  where id="+did;
  dao.commOper(s);
  }
  ...
  <TR>
    ...
    <TD  height=24 align="center" class=forumrowhighlight><a href="notice.jsp?did=<%=m.get("id") %>">删除</a></TD>
  </TR>
  <%} %>
