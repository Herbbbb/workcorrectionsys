...
<BODY>
<form action="/workcorrectionsys/pages/ksnotice.jsp?f=f" name="f1" method="post">

<%
String url="/workcorrectionsys/pages/ksnotice.jsp?1=1";
...
border=0>
  ...
  <TR>
    <TD height=24 colspan="2" align="center" class=forumrow>
      <input type="submit" name="Submit"  value="查询信息">&nbsp;&nbsp;&nbsp;<input type="button" onclick="add();" name="Submit" value="添加考试信息">
...
border=0>
  ...
  <TR>
    ...
    <TD  height=24 align="center" class=forumrowhighlight><a href="ksnotice.jsp?did=<%=m.get("id") %>">删除</a></TD>
  </TR>
  <%} %>
