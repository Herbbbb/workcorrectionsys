...
<BODY>
<form action="/gbgl/sys.do?action=uprm" name="f1" method="post" onsubmit="return ck()">
 <%
   CommDAO dao = new CommDAO();
  String id = request.getParameter("id");
  if(id==null)id = (String)request.getAttribute("id");
  String s = "select * from rmfw where id ="+id;
...
if(suc!=null)
{
 %>
 alert("操作成功");
   parent.location.replace("/gbgl/pages/rmfw.jsp");
 <%}%>
 </script>
