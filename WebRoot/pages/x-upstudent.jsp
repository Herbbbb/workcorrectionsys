...
<BODY>
  ...
  HashMap map = dao.select(s).get(0);
   %>
<form action="/workcorrectionsys/sys.do?action=upstudent" name="f1" method="post" onsubmit="return ck();" enctype="multipart/form-data"> 
...
border=0>
  ...
  <TR>
    <TD width="35%" height=24 align="center" class=forumrow>登陆名</TD>
    <TD class=forumrowhighlight width="65%" 
      height=24><label>
      <input name="uname" type="text" id="uname" size="40" disabled=disabled>
    </label></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=forumrowhighlight  height=80 colspan="2"><img src="../upfile/<%=map.get("img") %>" width="100" height="80"/>
    <input type="submit" name="Submit"  value="提交信息">&nbsp;&nbsp;&nbsp;<input type="reset" name="Submit" value="重新填写">
    </TD></TR>
