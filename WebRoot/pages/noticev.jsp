...
<BODY>
<form action="/workcorrectionsys/pages/noticev.jsp?f=f" name="f1" method="post">

<%
String url="/workcorrectionsys/pages/noticev.jsp?1=1";
...
border=0>
  ...
  function update(no)
  {
   location.href("upnotice.jsp?id="+no);
    ...
    function v(no)
  {
   location.href("noticex.jsp?id="+no);
  }
  </script>
