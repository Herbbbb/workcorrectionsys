...
<BODY>
  ...
  HashMap map = dao.select(s).get(0);
   %>
<form action="/workcorrectionsys/sys.do?action=answerfb" name="f1" method="post" onsubmit="return ck()" enctype="multipart/form-data"> 
...
border=0>
  <TBODY>
             ...
             <TR>
    <TD width="35%" height=24 align="center" class=forumrow>答案</TD>
