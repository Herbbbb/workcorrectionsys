...
<BODY>
<form action="/workcorrectionsys/pages/mystudents.jsp?f=f" name="f1" method="post">

<%
String url="/workcorrectionsys/pages/mystudents.jsp?1=1";
...
String sql = "select * from student where delstatus=0 and bj in ("+admin.get("bjid")+") ";
if(!key.equals(""))
{
url+="&key="+key;
...
border=0>
  <TBODY>
  <TR>
    <TD colSpan=2 height=24>我的学生</TD> 
  </TR>
  <TR>
